...
2. Внесите информацию о себе в раздел "Информация о студенте" (файл `README.md`).
...
7. Повторите пункты 4-6 до получения макс. кол-ва баллов за задание.

## 4. Ограничения

- Запрещается вносить изменения в файлы, не указанных в разделе "Описание задания".
- Запуск auto-grading тестов осуществляется вручную во вкладке Actions (причина - экономии выделенных GitHub'ом ресурсов).
...
- Тесты подразделяются на (1) локальные и (2) auto-grading:
...
- При клонировании репозитория через терминал используйте команду `git clone -j2 --recurse-submodules <URL>`

---

**Преподаватель**: Рамиль Сафин (Telegram: [_@safin_ramil_](https://t.me/safin_ramil)).