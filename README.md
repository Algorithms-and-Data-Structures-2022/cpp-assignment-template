...
- Запуск auto-grading тестов осуществляется автоматически в случае внесения изменений в [_src_](src) и/или [_include_](include)
в ветке _**master**_ или вручную во вкладке Actions.
